...
try:
    ...
    print("Warning: failed to import ttsfrd, trying WeTextProcessing or fallback normalizer")
    try:
        from tn.chinese.normalizer import Normalizer as ZhNormalizer
        from tn.english.normalizer import Normalizer as EnNormalizer
        use_ttsfrd = False
    except ImportError:
        print("Warning: failed to import WeTextProcessing, using simple text normalizer")
